...
Private Sub Form_Load()
   ...
   a_strEdit(1) = "已编辑"
   If flag = 1 Then
      strSQL = "select ID,ZLBZ,BZMC,GYFS,YFMC,YFJX,ZZ,YWXX,YW_ID,CCXX,BZ,BJZT from C_YFLF "
...
On Error GoTo errhandle
   ...
   strCondition = " GYFS is NULL and YFMC is NULL and YFJX is NULL and ZZ is NULL and YWXX is NULL and CCXX is NULL and BZ is NULL "
