...
Private Sub Form_Load()
    ...
    '
     ...
     strSQL = "select JTZlGC_ID from " & strstep & " where ZLLX = 1 and LCYJ_ID = "
      strSQL = strSQL & LCYJIDtemp
      Set recEdited = OraDatabase.CreateDynaset(strSQL, 0&)
       strstep = prefixname & "YFLF"
      strSQL = "select ZLGC_ID,GYFS,YFMC,YFJX,ZZ from " & strstep
      ...
      strSQL = "select ZLGC_ID,GYFS,YFMC,YFJX,ZZ from " & strstep & "  where 1<>1"
      Set recFields = OraDatabase.CreateDynaset(strSQL, 0&)
