...
Private Sub Form_Load()
   ...
   If flag = 1 Then
      strSQL = "select ID,JCXM,JCSJ,BHZB,GCFZ,YW_ID,CCXX,BZ,BJZT from C_SYJC "
...
Private Sub cmdQuery_Click()
   ...
   If chkmc.Value Then
      ...
      strCondition = strCondition & " JCXM like '%" & txtmc.Text & "%'"
   End If
