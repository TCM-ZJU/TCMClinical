...
Private Sub cmdQuery_Click()
    ...
    If txtCondition.Text = "" Then
        FrmQUERYD.objOO4O.RecordSource = "select LCZL_ID as 临床诊疗ID, LCYJ_ID as 临床研究ID from " & strstep & " where 1=1"
    Else
        strCondition = txtCondition.Text
        FrmQUERYD.objOO4O.RecordSource = "select LCZL_ID as 临床诊疗ID, LCYJ_ID as 临床研究ID from " & strstep & strCondition
    End If
