...
Private Sub Form_Load()
   ...
   a_strEdit(1) = "已编辑"
   If flag = 1 Then
      strSQL = "select ID,ZLBZ,BZMC,LB,XWXX,FF,QXSJ,SF,CS,JL,ZZ,YW_ID,CCXX,BZ,BJZT from C_ZTLF "
...
On Error GoTo errhandle
   ...
   strCondition = " XWXX is NULL and FF is NULL and QXSJ is NULL and SF is NULL and CS is NULL and JL is NULL and ZZ is NULL and CCXX is NULL and BZ is NULL "
