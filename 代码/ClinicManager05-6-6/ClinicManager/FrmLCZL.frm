...
Private Sub Form_Load()
   ...
   a_strEdit(1) = "已编辑"
   If flag = 1 Then
      strSQL = "select ID,BZZMC,ZDZBFL,ZBQZ,ZBXM,LXBZLY,LXBZ,ZDBZLY,ZDYQ,ZYZDFF,ZYXL,YW_ID,CCXX,BZ,BJZT from C_LCZL "
...
Private Sub cmdQuery_Click()
   ...
   If chkmc.Value Then
      ...
      strCondition = strCondition & " BZZMC like '%" & txtmc.Text & "%'"
   End If
