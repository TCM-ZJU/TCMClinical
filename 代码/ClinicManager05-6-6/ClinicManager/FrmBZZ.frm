...
Private Sub Form_Load()
   ...
   If flag = 1 Then
      strSQL = "select ID,JBMC,YFB,BFZ,ZHMC,ZZMC,YW_ID,CCXX,BZ,BJZT from C_BZZ "
...
Private Sub cmdQuery_Click()
   ...
   If chkmc.Value Then
      ...
      strCondition = strCondition & " JBMC like '%" & txtmc.Text & "%'"
   End If
